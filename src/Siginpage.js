        ...
        <div className="signinpage">
           ...
           <h5>Password</h5>
            ...
            <p className="terms_and_conditions">
                <spam classname="just-term_and_condtion_text">By containuing, you agree to Amazon's </spam>
                <spam  className="link_text">Conditions of Use </spam>
                <spam classname="just-term_and_condtion_text">and </spam>
                <spam className="link_text">Privacy</spam>
            </p>
            <spam className="link_text">Need help?</spam>
            <button onClick={signIn}>Sign in</button>
           </div>
        
          <div className="new_to_amazon">
                 <p className="text">New to Amazon?</p>
                 <button onClick={createAcount} className="create_acount_button">Create your Amazon account</button>
           </div>
